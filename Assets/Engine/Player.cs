...
namespace Mancala
{
    ...
    public abstract class Player
    {
        ...
        public Player(Position pos, String n, int maxTimePerMove)
        {
            ...
            UnityEngine.Debug.Log("Player " + name + " playing on ");
			if (pos == Position.Top) UnityEngine.Debug.Log("top.");
			if (pos == Position.Bottom) UnityEngine.Debug.Log("bottom.");
            if (pos != Position.Top && position != Position.Bottom)
            {
                UnityEngine.Debug.Log("...an illegal side of the board.");
                Environment.Exit(1);
            }
        }
